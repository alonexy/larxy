            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('log-viewer::logs.download', [$log->date]) }}?f={{$_REQUEST['f'] or ''}}" class="btn btn-xs btn-success">
...
@section('modals')
    ...
    <div id="delete-log-modal" class="modal fade">
        <div class="modal-dialog">
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}?f={{$_REQUEST['f'] or ''}}" method="POST">
    ...
    <script>
        $(function () {
            ...
            $(".pagination a").each(function(k,v){
                console.log()
                $(v).attr('href',$(v).attr('href')+'&f={{$_REQUEST['f'] or ''}}')
            })
        });
    </script>
@endsection
