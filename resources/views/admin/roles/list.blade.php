        ...
        <div class="box-body table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a style="font-size: 16px" href="{{URL::route("admin::role::edit")}}?id={{$val->id or 0}}"><i class="fa fa-fw fa-pencil" title="修改"></i></a>
        ...
        $(document).ready(function () {
            $(".del_uer").bind({
                click:function(){
                    ...
                    layer.confirm('删除角色，绑定改角色的账号将无法登陆', {
                        btn: ['确认','取消'] //按钮
                    }, function(){
                        $.ajax({
                            type : "POST",  //提交方式
