                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ route('log-viewer::logs.filter', [$date, $key]) }}?f={{$_REQUEST['f']}}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('log-viewer::logs.show', [$date]) }}?f={{$_REQUEST['f']}}" class="btn btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('log-viewer::logs.download', [$date]) }}?f={{$_REQUEST['f']}}" class="btn btn-xs btn-success">
